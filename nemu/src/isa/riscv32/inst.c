...
enum {
    TYPE_R, TYPE_B, TYPE_J, TYPE_I, TYPE_U, TYPE_S,
    TYPE_N, // none
};
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
    ...
    INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(rd) = (word_t)((uint64_t)((uint64_t)src1 * (uint64_t)src2) >> 32));
    ...
    INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , I, s->dnpc = cpu.mepc; set_status_bit(MIE_offset, get_status_bit(MPIE_offset)); set_status_bit(MPIE_offset, 1));
